<?php
    ...
    $ID_Tiposorteo = 0;
    $sql = "SELECT * FROM tipo_sorteos  WHERE id_sorteo = 3 AND estado ='En Proceso' AND id_usuario=$idUsuario";
    ...
    if ($resultado->num_rows>0) {
     ...
     if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        VALUES ($numeroSele, $monto, $idUsuario, 3, 0, '$mes', $ID_Tiposorteo)";
        ...
        if ($conn->query($sql) == TRUE) {
            ...
            header('Location: sorteo-tres.php?errorNumero=true');
            exit();
        }
                           ...
                           <div class="steps">
                                <div class="right">
                                    <form action="guardar-sorteo.php" method="POST">
                                        <input type="hidden" id="sorteoId" name="sorteoId" value="3">
                                        <ul> 
                                            <li>
                                                <div class="item">
                ...
                <div class="row">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-md-6">
                                <div class="single-pick">
                                    <form action="sorteo-tres-session.php" method="POST">
                                        ...
                                        <div class="header-area">
                                            <input type="number" name="monto" id="monto" max="10000" min="100" required>
                    ...
                    <div class="col-lg-5">
                        <div class="cart-summary">
                            ...
                            <div class="middle-area">
                                <?php 
                                    $sql = "SELECT * FROM numeros WHERE id_sorteo = 3 AND id_usuario=$idUsuario AND comprado = 0";
                                    $resultado = $conn->query($sql);
                                    ...
                                    if ($resultado->num_rows>0) {
                                        ...
                                        {
                                            echo "<div class='tikit'>";
                                             echo "<span class='left'>".$fila['mes']."</span>";
                                            echo "<span class='left'>".$fila['numero']."</span>";
                                            echo "<span class='right'>₡".$fila['monto']."</span>";
                                            echo '<div class="buttons">
                                                        <a href="sorteo-tres-session.php?id='.$fila['id_numero'].'" class="custom-button2">
                            ...
                            <div class="bottom-area">
                                <div class="total-area">
                                    ...
                                    <?php 
                                    $sql = "SELECT SUM(monto) AS total FROM numeros WHERE id_sorteo = 3 AND id_usuario= $idUsuario AND comprado = 0";
                            ...
                            <?php 
                                ...
                                if ($resultado->num_rows>0) {?>
                                    <form action="actualizarBD.php" method="POST">
                                        <input type="hidden" name="idSorteo" id="idSorteo" value="3">
                                        <div class="form-group">
                                            <?php  
                                            $sqlsorteo = "SELECT * FROM tipo_sorteos  WHERE id_sorteo=3 AND estado ='En Proceso' AND id_usuario=$idUsuario";
