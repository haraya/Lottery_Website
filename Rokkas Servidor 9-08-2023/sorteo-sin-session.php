                ...
                <div class="col-lg-12">
                    ...
                    <div>
                        <div class="box">
                            <div class="steps">
                                <div class="right">
                                    <form action="guardar-numero.php" method="POST">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 col-md-6">
                                <div class="single-pick">
                                    <form id="sorteo-uno.php" method="POST">
                                        ...
                                        <div class="body-area">
                                            <ul>
                                                ...
                                                <li>
                                                    <label>
                                                        <input type='radio' name='numeroSele' id="numeroSele" value="<?php echo $i; ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="log-reg-inner">
                        ...
                        <div class="main-content">
                            <h3>Debe iniciar sesion para poder participar</h3>
                        </div>
                    </div>
                </div>
            </div>
