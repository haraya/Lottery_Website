<?php
   require_once 'configBD.php';
    ...
    $ID_Tiposorteo = 0;
    $sql = "SELECT * FROM tipo_sorteos  WHERE id_sorteo = 2 AND estado ='En Proceso' AND id_usuario=$idUsuario";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    VALUES ($numeroSele, $monto, $idUsuario, 2, 0, NULL, $ID_Tiposorteo)";
    ...
    if ($conn->query($sql) == TRUE) {
        ...
        header('Location: sorteo-dos.php?errorNumero=true');
        exit();
    }
                            ...
                            <div class="steps">
                                <div class="right">
                                    <form action="guardar-sorteo.php" method="POST">
                                        <input type="hidden" id="sorteoId" name="sorteoId" value="2">
                                        <ul> 
                                        <li>
                                            <div class="item">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 col-md-6">
                                <div class="single-pick">
                                    <form action="sorteo-dos-session.php" method="POST">
                        ...
                        <div class="cart-summary">
                            ...
                            <div class="middle-area">
                                <?php 
                                    ...
                                    $sql = "SELECT * FROM numeros  WHERE id_sorteo = 2 AND id_usuario=$idUsuario AND comprado = 0";
                                    $resultado = $conn->query($sql);
                                    ...
                                    if ($resultado->num_rows>0) {
                                        ...
                                        while ($fila = $resultado ->fetch_assoc()) 
                                        {
                                            ...
                                            echo '<div class="buttons">
                                                        <a href="sorteo-dos-session.php?id='.$fila['id_numero'].'" class="custom-button2">
                            ...
                            <div class="bottom-area">
                                <div class="total-area">
                                    ...
                                    <?php 
                                    $sql = "SELECT SUM(monto) AS total FROM numeros WHERE id_sorteo = 2 AND id_usuario=$idUsuario AND comprado = 0";
                        ...
                        <div class="main-content">
                            ...
                            <?php 
                                ...
                                if ($resultado->num_rows>0) {?>
                                    ...
                                    <input type="hidden" name="idSorteo" id="idSorteo" value="2">
                                        <div class="form-group">
                                            <?php  
                                            $sqlsorteo = "SELECT * FROM tipo_sorteos  WHERE id_sorteo=2 AND estado ='En Proceso' AND id_usuario=$idUsuario";
